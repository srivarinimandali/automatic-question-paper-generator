...
?>
<center><h3><?php echo $year;?> B.Tech.&nbsp;<?php echo $sem; ?>&nbsp;Semester - Mid II Examination&nbsp;<?php echo $month; ?>-<?php echo $ye; ?></p>
<p>Academic Year&emsp;<?php echo $ay; ?></p></center></h3>
<p><h4>Subject:&nbsp;<?php echo $sub;?>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Max Marks:&nbsp;10<br>
<br><p>SubjectCode:&nbsp;<?php echo $subcode;?>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Time:&nbsp;1 hr<br>
<p>Branch:&nbsp;<?php  
 $i = 0;
...
if($q%2==1){
if($un==3){
$query1=mysqli_query($conn,"select distinct * from questions where (subjectcode='$subcode' and subject='$sub' and marks=2 and unitno='3-2') or (subjectcode='$subcode' and subject='$sub' and marks=3 and unitno='3-2') order by rand();") or die("query failed");
...
{
if($un==3){
     $query2=mysqli_query($conn,"select distinct * from questions where (subjectcode='$subcode' and subject='$sub' and marks=5 and unitno='3-2') or (subjectcode='$subcode' and subject='$sub' and marks=10 and unitno='3-2') order by rand();") or die("query failed");
    $row=mysqli_fetch_assoc($query2);
}
else if($un==6){
     $query2=mysqli_query($conn,"select distinct * from questions where (subjectcode='$subcode' and subject='$sub' and marks=5 and unitno='4') or (subjectcode='$subcode' and subject='$sub' and marks=10 and unitno='4') order by rand();") or die("query failed");
    $row=mysqli_fetch_assoc($query2);
}
else{
