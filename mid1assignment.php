...
<p>
<img src="assignment5.gif"  align="right" width="800" height="563" >
<center><b><h4><i><font color="white"><br>ASSIGNMENT<br><br>MID-1</h4></b><br><br><br>
<form name="f1" action="ass1.php" method="post">
...
<p>Subject &nbsp &nbsp&nbsp &emsp;&emsp;:&emsp;<input type="text" name="sub" list="sub" placeholder=" Enter Subject Name" style="height: 30px; width: 300px ;" autocomplete="off" required>
<datalist id="sub">
