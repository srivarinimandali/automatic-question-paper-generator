...
<p>
<img src="mid2.gif"  align="left" width="800" height="562" >
<center><b><h4><i><font color="white">&emsp;&emsp; MID-1 EXAMINATION</h4></b>
<form action="questionpaper.php" method="post">
&emsp;&emsp;&emsp;&emsp;&emsp;Subject Code &emsp;:&emsp;<input type="text" list="subcode"name="subcode" autocomplete="off" placeholder=" Enter Subject Code" style="width: 250px;
height: 30px;"required>
<datalist id="subcode">
<option value="134AK" />
<option value="135AR" /></datalist>
...
<br><br>&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&emsp;&emsp;&emsp;&emsp;Subject&emsp;:&emsp;<input type="text" list="sub" autocomplete="off" name="sub" placeholder=" Enter Subject Name" style="width: 250px;
...
Date of Examination&emsp;:&emsp;&nbsp;<input type="date" name="date" placeholder=" Enter DD/MM/YY" style="width: 250px;
...
Academic Year&emsp;&nbsp;:&emsp;&emsp;<input type="text" name="ay" placeholder=" Enter Year-Year" style="width: 250px;
