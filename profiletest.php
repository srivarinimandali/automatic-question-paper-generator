...
?>
<p><h3><font color="white">Name&nbsp&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;:<?php echo'<input type="text" name="name" value='.$row['name'].' style="width: 250px;height: 30px;" required><br/>' ?>
<p>Employee ID&emsp;&emsp;&emsp;:<?php echo'<input type="text" name="empid" value='.$row['empid'].' style="width: 250px;height: 30px;" ><br>' ?>
