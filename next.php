...
$conn=mysqli_connect("localhost","root","") or die(mysqli_error());
  $db=mysqli_select_db($conn,"mini") or die(mysqli_error());
   $q="update questions set question='$question',subjectcode='$subcode',subject='$sub',level='$level',marks='$marks',semester='$sem',year='$year',unitno='$unitno' where qid='$qid'";
...
<body>
<font color="white">
<h2><img src="next8.png" width="125" height="125" align="left" >&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;UPDATED SUCCESSFULLY</h2>
<br><br><h3> Below are the details of the updated question:</h3><br>
...
<form action="update.php">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<input type="submit" class="b" value="Update another question" style="color:white;background-color:#8f6fc9">
</form><bR>
